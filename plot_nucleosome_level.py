...
EXON_LENGTH = {1: 448, 2: 287, 3: 277, -3: 486, -2: 271, -1: 332}
INTRON_LENGTH = {1: 222, 2: 183, -2: 155, -1: 151}
START = -4000
...
# read the cov file
data = pd.read_table('Control_danpos_norm.smooth.bedgraph1', header=None,
